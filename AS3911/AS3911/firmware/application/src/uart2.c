...
#define BAUDRATE_MISTAKE 1000*(BAUDRATE2-SYSCLK/16/(BAUDRATEREG2+1))/BAUDRATE2
...
/*****************************************************************************
 * Function: UART2GetCmd
 *
 * Precondition: UART2Init must be called before.
 *
 * Overview: Get the command byte received by UART
 *
 * Input: None.
 *
